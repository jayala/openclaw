...
- Android: keep wake-word listening active after the app leaves the screen by holding the microphone foreground-service type while Voice Wake is enabled, and speak the final reply to a wake-word command through the Talk voice instead of showing text only.
